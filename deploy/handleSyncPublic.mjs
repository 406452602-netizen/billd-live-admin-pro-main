...
if (process.cwd().indexOf('galaxy-s10') !== -1) {
  ...
  clearOld().then(() => {
    ...
    proPkg.name = 'billd-live-admin';
    proPkg.repository.url = 'https://github.com/galaxy-s10/billd-live-admin';
    proPkg.bugs.url = 'https://github.com/galaxy-s10/billd-live-admin/issues';
